  ...
  return (
    ...
    <div className='container-header flex flex-row h-20 fixed left-0 right-0'>
      ...
      <div className='links-container-header flex justify-end flex-row basis-5/6'>
        <div className='links-header w-24 place-self-center'>events</div>
        <div className='links-header w-24 place-self-center'>sponsors</div>
        <div className='links-header w-24 place-self-center'>glimpses</div>
        <div className='links-header w-24 place-self-center'>team</div>
        <div className='links-header w-16 place-self-center'>

  ...
  <div className={Classes.MajorBod} >
    ...
    <div className={Classes.CardPh}>
      <div class="flex flex-col text-center justify-center items-center  ">
        ...
        <div class=" flex flex-rows h-[30px] justify-center font-bold text-3xl"><div className="ml-4  mt-5font-bold text-[30px] p-[10px]">Instameet & Adobe Lightroom</div></div>
        ...
        <p class="text-justify mx-2 w-[290px] mt-5">Satyam Bhuyan, a gifted photographer with an engineering and MBA background, creates visual masterpieces. As a Nikon India and Lightroom Ambassador, he elevates travel photography and NFT artistry to new heights.
        </p>

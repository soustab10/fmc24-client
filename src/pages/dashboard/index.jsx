...
{/* 
                                ...
                                <div class="w-[392px] h-[267px] justify-center my-6   hover:shadow-amber-100/20  transition-all border mx-2 border-white bg-gradient-to-t from-white/10 to-white/30 text-white rounded-[14px] bg-opacity-10 backdrop-blur-lg  shadow-xl drop-shadow-xl bg-blend-normal z-10 ">
...
{/* 
                                ...
                                <div class="w-[392px] h-[267px] justify-center hover:shadow-amber-100/20 transition-all my-6 border mx-2 border-white bg-gradient-to-t from-white/10 to-white/30 text-white rounded-[14px] bg-opacity-10 backdrop-blur-lg  shadow-xl drop-shadow-xl bg-blend-normal z-10 ">
                                    <div class="flex flex-col text-center justify-center align-middle px-6 py-4">
                                    <Link href="/cart">
                                        <div class=" flex flex-rows justify-around font-bold text-7xl text-black mb-2 my-5"><div>+</div></div>

...
const About = () => {
  return (
    ...
    <Image  className={Classes.img1} alt="" src='/2.jpg' height={720} width={479} />
    </div>
    ...
    <Image className={Classes.img1} alt="" src='/3.jpg' height={720} width={447} />
    </div>
    ...
    <Image className={Classes.img1} alt="" src='/4.jpg'  height={720} width={480} />
    </div>
    ...
    <Image  className={Classes.img1} alt="" src='/5.jpg'  height={828} width={552} />
    </div>
